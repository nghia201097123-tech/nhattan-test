    ...
    constructor(entity?: any) {
        ...
        if (entity) {
            Object.assign(this, defaults, {
                ...
                shipping_fee: +entity.delivery_amount || 0,
                ...
                channel_order_id: entity.order_id || '',
                channel_order_code: entity.order_code || '',
                ...
                tracking_url:'',
                is_cancel_printed:+entity.is_cancel_printed || 0,
                is_cancel_order:+entity.is_cancel_order || 0,
            });
        } else {
            Object.assign(this, defaults);
        }
