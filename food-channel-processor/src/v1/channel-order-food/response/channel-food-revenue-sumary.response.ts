...
export class ChannelFoodRevenueSumaryResponse {
  ...
  constructor(entity?: ChannelFoodRevenueSumaryDataModel) {
    this.report_date = entity ? entity.report_date : '';
    
    this.total_order_SHF = entity ? +entity.total_order_SHF : 0;
    this.total_order_GRF = entity ? +entity.total_order_GRF : 0;
    this.total_order_GOF = entity ? +entity.total_order_GOF : 0;
    this.total_order_BEF = entity ? +entity.total_order_BEF : 0 ;
    ...
    this.commission_amount_GOF = entity ? +entity.commission_amount_GOF : 0;
    ...
    this.order_amount_GOF = entity ? +entity.order_amount_GOF : 0;
    ...
    this.total_amount_GOF = entity ? +entity.total_amount_GOF : 0;
