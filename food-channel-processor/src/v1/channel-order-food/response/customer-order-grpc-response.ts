...
import { CustomerOrderOnlineResponse } from 'src/v1/grpc/interfaces/customer-order-for-channel-food';
...
export class CustomerOrderGrpcResponse {
  ...
  is_cancel_printed : number = 0;

  is_cancel_order : number = 0;
  ...
  constructor(entity?: any) {
    ...
    this.shippe_name = ''; // Not present in the original object
    ...
    this.channel_order_code = '';
    this.is_app_food = 0;
    this.is_printed = 0;
    this.is_cancel_printed = 0;
    this.is_cancel_order = 0;

    this.is_scheduled_order = entity?.is_pre_order ?? 0;
    this.deliver_time = entity?.pre_order_time ?? '';

  }

  public mapToList(data: CustomerOrderOnlineResponse[]) {
