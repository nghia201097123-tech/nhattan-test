...
export class CustomerChannelFoodInformationReportResponse {
    ...
    constructor(data?: CustomerChannelFoodInformationReportDataModel) {
      ...
      this.total_order = +data?.total_order ?? 0;
      this.total_order_SHF = +data?.total_order_SHF ?? 0;
      this.total_order_GRF = +data?.total_order_GRF ?? 0;
      this.total_order_GOF = +data?.total_order_GOF ?? 0;
      this.total_order_BEF = +data?.total_order_BEF ?? 0;
