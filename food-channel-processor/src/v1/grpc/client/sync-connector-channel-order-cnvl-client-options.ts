...
dotenv.config();
export const grpcClientSyncConnectorChannelOrderCnvl: ClientOptions = {
    transport: Transport.GRPC,
    options: {
        url: `${process.env.CONFIG_GRPC_NODEJS_FOOD_CHANNEL_CONNECTOR_CNV_LOYALTY_HOST ?? process.env.CONFIG_GRPC_NODEJS_FOOD_CHANNEL_CONNECTOR_BEFOOD_HOST}:${process.env.CONFIG_GRPC_NODEJS_FOOD_CHANNEL_CONNECTOR_CNV_LOYALTY_PORT ?? process.env.CONFIG_GRPC_NODEJS_FOOD_CHANNEL_CONNECTOR_BEFOOD_PORT}`,
        package: [
