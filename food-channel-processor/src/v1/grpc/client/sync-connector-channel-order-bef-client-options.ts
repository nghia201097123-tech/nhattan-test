...
dotenv.config();
export const grpcClientSyncConnectorChannelOrderBef : ClientOptions = {
    transport: Transport.GRPC,
    options: {
        url: `${process.env.CONFIG_GRPC_NODEJS_FOOD_CHANNEL_CONNECTOR_BEFOOD_HOST}:${process.env.CONFIG_GRPC_NODEJS_FOOD_CHANNEL_CONNECTOR_BEFOOD_PORT}`,
        package: [
