...
dotenv.config();
export const grpcClientFoodChannelConnector : ClientOptions = {
    transport: Transport.GRPC,
    options: {
        url: `${process.env.CONFIG_GRPC_NODEJS_FOOD_CHANNEL_CONNECTOR_HOST}:${process.env.CONFIG_GRPC_NODEJS_FOOD_CHANNEL_CONNECTOR_PORT}`,
        package: [
