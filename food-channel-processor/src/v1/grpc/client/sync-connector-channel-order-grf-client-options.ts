...
dotenv.config();
export const grpcClientSyncConnectorChannelOrderGrf : ClientOptions = {
    transport: Transport.GRPC,
    options: {
        url: `${process.env.CONFIG_GRPC_NODEJS_FOOD_CHANNEL_CONNECTOR_GRABFOOD_HOST}:${process.env.CONFIG_GRPC_NODEJS_FOOD_CHANNEL_CONNECTOR_GRABFOOD_PORT}`,
        package: [
