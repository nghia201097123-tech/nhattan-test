 ...
 * 
 */
export class StoreProcedureValidatorTime {
  ...
  public validatorTime() {
    ...
    switch (+this.report_type) {
      case ReportTypeEnum.HOUR:
        ...
        toDate = moment(this.date_time).add(1, "day").format("YYYY-MM-DD");
      ...
      case ReportTypeEnum.YESTERDAY:
        ...
        fromDate = moment(this.date_time)
          .subtract(1, "day")
          .format("YYYY-MM-DD");
    ...
    switch (+this.report_type) {
      case ReportTypeEnum.OPTION_HOUR:
        ...
        fromDate = moment(this.from_date).format("YYYY-MM-DD");
        toDate = moment(this.to_date).add(1, "day").format("YYYY-MM-DD");
        groupType = GroupByEnum.GROUP_HOUR;
        break;
