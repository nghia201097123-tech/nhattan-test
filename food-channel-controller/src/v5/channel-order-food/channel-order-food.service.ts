...
import { catchError, defaultIfEmpty, delay, lastValueFrom, retry, retryWhen, take, tap, throwError, timer } from 'rxjs';
...
import { BatchConfirmChannelOrderResponseResultResponse, ChannelOrderServiceClient, OrderBaseResponse, ResultBaseResponse, ResultV3BaseResponse } from '../grpc/interfaces/channel-order';
...
import { FoodChannelProcessorApiEnum } from 'src/utils.common/utils.enum/utils.food-channel-processor-api';
...
export class ChannelOrderFoodService {
  ...
  async getEarningSumaryReportV2Grpc(
    ...
    try {
      let data = await lastValueFrom(this.channelOrderFoodReportService.getEarningSumaryReportV2(
        {
          restaurant_id: restaurantId,
          restaurant_brand_id: restaurantBrandId,
          branch_id: branchId,
  ...
  async getOrderDetailGrpcV2(
    ...
    try {
      ...
      let data = await lastValueFrom(this.channelOrderService.getOrderDetailV2(
        {
          id: id,
          is_app_food: isAppFood,
          restaurant_id: restaurantId
  ...
  async getOrdersGrpcV2(
    ...
    try {
      ...
      let data = await lastValueFrom(this.channelOrderService.getOrdersV2(
        {
          restaurant_id: restaurantId,
          restaurant_brand_id: restaurantBrandId,
          branch_id: branchId,
  ...
  async getOrdersGrpcV3(
    ...
    tokens: string,
    isUseKafka
  ): Promise<ResultV3BaseResponse> {

    try {      

      let data = await lastValueFrom(this.channelOrderService.getOrdersV3(
        {
          restaurant_id: restaurantId,
          restaurant_brand_id: restaurantBrandId,
          branch_id: branchId,
  ...
  async getOrdersGrpcV4(
    ...
    try {      
      ...
      let data = await lastValueFrom(this.channelOrderService.getOrdersV4(
        {
          restaurant_id: restaurantId,
          restaurant_brand_id: restaurantBrandId,
          branch_id: branchId,
  ...
  async handleCompleteChannelOrderV2Grpc(
    restaurantId: number,
    id: number,
    ...
    try {
      ...
      let data = await lastValueFrom(this.channelOrderService.handleCompleteChannelOrderV2(
        {
          restaurant_id: restaurantId,
          id: id,
  ...
  async handleCompleteChannelOrderV3Grpc(
    restaurantId: number,
    id: number,
    restaurantOrderId:number
  ): Promise<BaseEmptyResponse> {
    ...
    try {
      ...
      let data = await lastValueFrom(this.channelOrderService.handleCompleteChannelOrderV3(
        {
          restaurant_id: restaurantId,
          id: id,
          restaurant_order_id:restaurantOrderId
  ...
  async handleCancelChannelOrderV2Grpc(
    restaurantId: number,
    id: number,
    restaurantOrderId:number
  ): Promise<BaseEmptyResponse> {
    ...
    try {
      ...
      let data = await lastValueFrom(this.channelOrderService.handleCancelChannelOrderV2(
        {
          restaurant_id: restaurantId,
          id: id,
          restaurant_order_id:restaurantOrderId
  ...
  async handleCancelChannelOrderV3Grpc(
    restaurantId: number,
    id: number,
    restaurantOrderId:number
  ): Promise<BaseEmptyResponse> {
    ...
    try {
      ...
      let data = await lastValueFrom(this.channelOrderService.handleCancelChannelOrderV3(
        {
          restaurant_id: restaurantId,
          id: id,
          restaurant_order_id:restaurantOrderId
  ...
  async batchConfirmChannelOrderGrpcV2(
    restaurantId: number,
    branchId: number,
    ids:string
  ): Promise<BatchConfirmChannelOrderResponseResultResponse> {
    ...
    try {
      ...
      let data = await lastValueFrom(this.channelOrderService.batchConfirmChannelOrderV2(
        {
          restaurant_id : restaurantId,
          branch_id: branchId,
          ids:ids
  ...
  async updateCancelPrintOrdersGrpcV2(
    restaurantId: number,
    branchId: number,
    ids:string
  ): Promise<any> {
    ...
    try {
      ...
      let data = await lastValueFrom(this.channelOrderService.updateCancelPrintOrdersV2(
        {
          restaurant_id : restaurantId,
          branch_id: branchId,
          ids:ids
  ...
  async getOrderDetailToPrintGrpc(
    id: number,
    restaurantId: number
  ): Promise<OrderBaseResponse> {
    ...
    try {
      ...
      let data = await lastValueFrom(this.channelOrderService.getOrderDetailToPrint(
        {
          id: id,
          restaurant_id: restaurantId
        }
  ...
  async getOrderDetailToPrintGrpcV2(
    id: number,
    restaurantId: number
  ): Promise<OrderBaseResponse> {
    ...
    try {
      ...
      let data = await lastValueFrom(this.channelOrderService.getOrderDetailToPrintV2(
        {
          id: id,
          restaurant_id: restaurantId
        }
  ...
  async batchConfirmChannelOrderHttp(
    ...
    try {
      ...
      console.log(`${process.env.CONFIG_NODEJS_FOOD_CHANNEL_PROCESSOR_ENDPOINT}${FoodChannelProcessorApiEnum.API_BATCH_CONFIRM}`);
      
      const data = await axios.post(
        `${process.env.CONFIG_NODEJS_FOOD_CHANNEL_PROCESSOR_ENDPOINT}${FoodChannelProcessorApiEnum.API_BATCH_CONFIRM}`,
        {
          restaurant_id: restaurantId,
          branch_id: branchId,
          ids: ids
      ...
      const message =
        error.response?.statusText || "Lỗi !";

      return new BaseResponseData(statusCode, message);
    }
  }

  async batchConfirmChannelOrderGrpcV3(
    restaurantId: number,
    branchId: number,
    ids:string
  ): Promise<BaseEmptyResponse> {
    ...
    try {
      ...
      let data = await lastValueFrom(this.channelOrderService.batchConfirmChannelOrderV3(
        {
          restaurant_id : restaurantId,
          branch_id: branchId,
          ids:ids
