...
export const grpcClientFoodChannelProcessorClientOptions : ClientOptions = {
    ...
    options: {
        ...
        protoPath: [
            ...
            join(process.cwd(), "src/v4/grpc/protos/branch-channel-food-commission-percent-map.proto"),
            join(process.cwd(), "src/v4/grpc/protos/channel-order-food.proto"),
            join(process.cwd(), "src/v4/grpc/protos/order-channel-order-food.proto"),
            join(process.cwd(), "src/v4/grpc/protos/channel-order-food-token.proto"),
            join(process.cwd(), "src/v4/grpc/protos/channel-order-food-report.proto"),
            join(process.cwd(), "src/v4/grpc/protos/channel-order.proto"),
            join(process.cwd(), "src/v4/grpc/protos/food-channel-setting.proto"),
