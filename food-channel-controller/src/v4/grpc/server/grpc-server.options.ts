...
export const grpcServerOptions: MicroserviceOptions = {
  ...
  options: {
    ...
    protoPath: [
      ...
      join(process.cwd(), "src/v4/grpc/protos/channel-order-food-server.proto"),
      join(process.cwd(), "src/v4/grpc/protos/order-channel-order-food-server.proto"),
      join(process.cwd(), "src/v4/grpc/protos/food-channel-setting-server.proto"),
